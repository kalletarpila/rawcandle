...
def _build_markdown(snapshot: Mapping[str, Any]) -> str:
    ...
    sections.extend([
        ...
        _table(("Kenttä", "Arvo"), (
            ...
            *(([("Report presentation contract", snapshot.get("report_presentation_contract"))] if snapshot.get("report_presentation_contract") else [])),
            *(([("Report presentation fingerprint", snapshot.get("report_presentation_fingerprint"))] if snapshot.get("report_presentation_fingerprint") else [])),
