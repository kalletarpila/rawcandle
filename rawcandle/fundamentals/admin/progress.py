...
class ProgressStage(str, Enum):
    ...
    PRODUCTION_LOGICAL_BASELINE = "PRODUCTION_LOGICAL_BASELINE"
    CAPTURE_COPIES = "CAPTURE_COPIES"
    VALIDATE_COPIES = "VALIDATE_COPIES"
    PREVIEW_VALIDATION = "PREVIEW_VALIDATION"
    LOAD_ACTIVE_TAXONOMY = "LOAD_ACTIVE_TAXONOMY"
    LOAD_CURATED_SOURCE = "LOAD_CURATED_SOURCE"
    LOAD_CANDIDATE = "LOAD_CANDIDATE"
    PAUSE_SCHEDULER_FOR_COPY = "PAUSE_SCHEDULER_FOR_COPY"
    CAPTURE_BASELINE_COPIES = "CAPTURE_BASELINE_COPIES"
    RESTORE_SCHEDULER = "RESTORE_SCHEDULER"
    BUILD_TEST_CANDIDATE = "BUILD_TEST_CANDIDATE"
    ...
    RELATIVE_POSITION_REFRESH = "RELATIVE_POSITION_REFRESH"
    RELATIVE_VALUATION_REFRESH = "RELATIVE_VALUATION_REFRESH"
    REPLAY_VERIFY = "REPLAY_VERIFY"
    FIXED_POINT_REPEAT = "FIXED_POINT_REPEAT"
    REPEAT_NO_CHANGE = "REPEAT_NO_CHANGE"
    INDEPENDENT_REPLAY = "INDEPENDENT_REPLAY"
    ROLLBACK_AFTER_DOWNSTREAM = "ROLLBACK_AFTER_DOWNSTREAM"
    ROLLBACK_VERIFY = "ROLLBACK_VERIFY"
    PRODUCTION_LOGICAL_POSTFLIGHT = "PRODUCTION_LOGICAL_POSTFLIGHT"
    PRODUCTION_POSTFLIGHT = "PRODUCTION_POSTFLIGHT"
    NO_CHANGE_VERIFICATION = "NO_CHANGE_VERIFICATION"
    PRODUCTION_NO_CHANGE_VERIFY = "PRODUCTION_NO_CHANGE_VERIFY"
    TARGETED_POSTFLIGHT = "TARGETED_POSTFLIGHT"
    TEST_PRODUCTION_WRITE_PATH = "TEST_PRODUCTION_WRITE_PATH"
    ...
    PUBLISH_DATE_BOOTSTRAP = "PUBLISH_DATE_BOOTSTRAP"
    CANONICAL_VALIDATION = "CANONICAL_VALIDATION"
    ANALYSIS_REBUILD = "ANALYSIS_REBUILD"
...
REFRESH_FUNDAMENTALS_TEST_STAGES: tuple[ProgressStage, ...] = (
    ProgressStage.PREVIEW_BINDING,
    ProgressStage.SOURCE_REVALIDATION,
    ProgressStage.COPY_PROVIDER,
    ProgressStage.PROVIDER_REPLACEMENT,
    ProgressStage.PROVIDER_VALIDATION,
    ProgressStage.PUBLISH_DATE_BOOTSTRAP,
    ProgressStage.CANONICAL_REBUILD,
    ProgressStage.CANONICAL_VALIDATION,
    ProgressStage.ANALYSIS_REBUILD,
    ProgressStage.ANALYSIS_VALIDATION,
    ProgressStage.IMPACT_COMPARISON,
    ProgressStage.REPORT,
    ProgressStage.CLEANUP,
    ProgressStage.COMPLETED,
)
...
TAXONOMY_ACCEPTANCE_STAGES: tuple[ProgressStage, ...] = (
    ProgressStage.PREFLIGHT,
    ProgressStage.PAUSE_SCHEDULER_FOR_COPY,
    ProgressStage.CAPTURE_BASELINE_COPIES,
    ProgressStage.RESTORE_SCHEDULER,
    ProgressStage.LOAD_ACTIVE_TAXONOMY,
    ProgressStage.BUILD_TEST_CANDIDATE,
    ProgressStage.RESOLVE_IDENTITIES,
    ProgressStage.VALIDATE_CANDIDATE,
    ProgressStage.BUILD_PREVIEW,
    ProgressStage.APPLY_TAXONOMY,
    ProgressStage.VALIDATE_APPLY,
    ProgressStage.REFRESH_DEPENDENCIES,
    ProgressStage.PACKAGE_REFRESH,
    ProgressStage.RELATIVE_POSITION_REFRESH,
    ProgressStage.RELATIVE_VALUATION_REFRESH,
    ProgressStage.SNAPSHOT_SMOKE,
    ProgressStage.REPEAT_NO_CHANGE,
    ProgressStage.INDEPENDENT_REPLAY,
    ProgressStage.ROLLBACK_VERIFY,
    ProgressStage.PRODUCTION_POSTFLIGHT,
    ProgressStage.CLEANUP,
    ProgressStage.COMPLETED,
)


TAXONOMY_DOWNSTREAM_CLOSURE_STAGES: tuple[ProgressStage, ...] = (
    ProgressStage.PREFLIGHT,
    ProgressStage.PAUSE_SCHEDULER,
    ProgressStage.PRODUCTION_LOGICAL_BASELINE,
    ProgressStage.CAPTURE_COPIES,
    ProgressStage.VALIDATE_COPIES,
    ProgressStage.APPLY_TAXONOMY,
    ProgressStage.ATTACH_DEPENDENCIES,
    ProgressStage.PACKAGE_REFRESH,
    ProgressStage.RELATIVE_POSITION_REFRESH,
    ProgressStage.RELATIVE_VALUATION_REFRESH,
    ProgressStage.SNAPSHOT_SMOKE,
    ProgressStage.FIXED_POINT_REPEAT,
    ProgressStage.INDEPENDENT_REPLAY,
    ProgressStage.ROLLBACK_AFTER_DOWNSTREAM,
    ProgressStage.PRODUCTION_LOGICAL_POSTFLIGHT,
    ProgressStage.RESTORE_SCHEDULER,
    ProgressStage.CLEANUP,
    ProgressStage.COMPLETED,
)
...
TAXONOMY_PRODUCTION_STAGES: tuple[ProgressStage, ...] = (
    ProgressStage.PREFLIGHT,
    ProgressStage.LOAD_CURATED_SOURCE,
    ProgressStage.BUILD_PREVIEW,
    ProgressStage.VALIDATE_PREVIEW,
    ProgressStage.PRODUCTION_NO_CHANGE_VERIFY,
    ProgressStage.TARGETED_POSTFLIGHT,
    ProgressStage.TEST_PRODUCTION_WRITE_PATH,
    ProgressStage.CLEANUP,
    ProgressStage.COMPLETED,
)
