...
from .contract import COMPONENTS, DELTA_MODEL_VERSION, model_fingerprint
...
def calculate_fundamental_delta(
    ...
    *,
    ...
    for row in (current, *company_history):
    ...
    payload = {
        ...
        "horizons": tuple(asdict(item) for item in horizons),
    }
