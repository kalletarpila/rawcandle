...
from rawcandle.fundamentals.admin.sector_industry import TEMP_ROOT, run_apply, run_preview


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Phase 13G.3 copy-only Sector/Industry administration CLI.")
    parser.add_argument("tickers", nargs="*", help="Optional ticker filter. No tickers scans the full active operational universe.")
    parser.add_argument("--input-file", type=Path, help="Optional file containing ticker filters.")
