...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Plan a guarded DATACENTER EC taxonomy full rebuild in bounded chunks")
...
def main(argv: list[str] | None = None) -> int:
    ...
    summary = plan_ec_taxonomy_full_rebuild(
        db_path=args.db,
    ...
    return 0 if summary.get("status") == "READY_TAXONOMY_FULL_REBUILD_PLAN" else 1
