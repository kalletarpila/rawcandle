...
from rawcandle.fundamentals.phase13d_backend import Phase13DPaths, apply_ticker_preview
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Phase 13D protected ticker onboarding apply on database copies")
    ...
    try:
        ...
        print(json.dumps({"ok": True, "outcome": result["outcome"], "output": str(args.output), "relative_valuation_state": result.get("relative_valuation_state")}, sort_keys=True))
        return 0
