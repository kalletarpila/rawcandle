...
ALLOWED_BUILD_STEPS = (
    ...
    AllowedBuildStep(7, "build_canonical_v3_ticker_freshness_from_signal_daily", ("eco_entity_metric_value", "eco_signal_observation"), ("dc_ticker_swing_signal_daily",), ("db_path", "run_id", "replace_existing=True")),
    AllowedBuildStep(8, "build_canonical_v3_daily_trigger_classifications", ("eco_classification_decision",), ("dc_ticker_swing_signal_daily", "dc_group_swing_signal_daily"), ("db_path", "run_id", "replace_existing=True")),
    AllowedBuildStep(9, "build_canonical_v3_rolling2_sell_pressure_classifications", ("eco_classification_decision",), ("dc_ticker_swing_signal_daily", "dc_group_swing_signal_daily"), ("db_path", "run_id", "replace_existing=True")),
    AllowedBuildStep(10, "build_canonical_v3_rolling5_pullback_classifications", ("eco_classification_decision",), ("dc_ticker_swing_signal_daily", "dc_group_swing_signal_daily"), ("db_path", "run_id", "replace_existing=True")),
    AllowedBuildStep(11, "build_canonical_v3_rolling30_watchlist_classifications", ("eco_classification_decision",), ("dc_ticker_swing_signal_daily", "dc_group_swing_signal_daily"), ("db_path", "run_id", "replace_existing=True")),
    AllowedBuildStep(12, "build_canonical_v3_window_snapshots", ("eco_entity_window_snapshot",), ("dc_ticker_swing_signal_daily", "dc_group_synthetic_ohlc_daily", "eco_entity_coverage", "eco_quality_summary", "eco_classification_decision", "eco_entity_metric_value"), ("db_path", "run_id", "replace_existing=True")),
    AllowedBuildStep(13, "build_canonical_v3_ma_status", ("eco_signal_observation",), ("dc_ticker_swing_signal_daily",), ("db_path", "run_id", "replace_existing=True")),
    AllowedBuildStep(14, "build_canonical_v3_ma_break_status", ("eco_signal_observation",), ("dc_ticker_swing_signal_daily",), ("db_path", "run_id", "replace_existing=True")),
    AllowedBuildStep(15, "build_canonical_v3_signal_relevance", ("eco_signal_observation", "eco_signal_relevance"), ("technical_signal_relevance",), ("db_path", "run_id", "technical_relevance_run_id", "window_code='daily'", "replace_existing=True")),
    AllowedBuildStep(16, "build_canonical_v3_ticker_structure_events", ("eco_entity_event",), ("stock_dow_structure_events",), ("db_path", "run_id", "replace_existing=True")),
    AllowedBuildStep(17, "build_canonical_v3_group_structure_events", ("eco_entity_event",), ("dc_group_synthetic_ohlc_daily",), ("db_path", "run_id", "replace_existing=True")),
)
