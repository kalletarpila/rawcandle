...
def run_smoke(paths: SmokePaths, *, ticker: str, test_free_tier_boundary: bool) -> dict[str, Any]:
    ...
    summary = {
        ...
        "artifact_root": str(paths.artifact_root),
        "client_path": "rawcandle/fundamentals/providers/sharadar.py",
        "smoke_cli_path": "rawcandle/cli/run_sharadar_v4_smoke.py",
        "provider_evaluation_doc": "docs/fundamentals_v4/fundamentals_v4_provider_strategy.md",
        "integration_doc": "docs/fundamentals_v4/fundamentals_v4_architecture.md",
        "next_action": next_action,
    }
    write_json(paths.artifact_root / "sharadar_smoke_summary.json", summary)
