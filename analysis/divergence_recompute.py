    ...
    try:
        ...
        records = [
            (                str(row["date"]),
                ...
                float(row.get("hidden_bearish_strength") or 0.0),
                ...
                int(row.get("is_hidden_bullish_divergence", 0) or 0),
                int(row.get("is_hidden_bearish_divergence", 0) or 0),
                int(row.get("is_bullish_divergence_r2", 0) or 0),
                int(row.get("is_bearish_divergence_r2", 0) or 0),
                int(row.get("is_hidden_bullish_divergence_r2", 0) or 0),
                int(row.get("is_hidden_bearish_divergence_r2", 0) or 0),
                int(row.get("is_bullish_divergence_r3", 0) or 0),
                int(row.get("is_bearish_divergence_r3", 0) or 0),
                int(row.get("is_hidden_bullish_divergence_r3", 0) or 0),
                int(row.get("is_hidden_bearish_divergence_r3", 0) or 0),
                row.get("pivot_gap"),
                ...
                row.get("hidden_pivot_gap_r2"),
                row.get("hidden_pivot_drop_pct_r2"),
                row.get("hidden_pivot_gap_r3"),
                row.get("hidden_pivot_drop_pct_r3"),
            )
