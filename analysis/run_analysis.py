    ...
    for i, row in df.iterrows():
        ...
        if "Hammer" in patterns:
            ...
            if ok:
                ...
                if logger:
                    logger.info(
                        f"{ticker} {row['pvm'].date().isoformat()} Hammer checked - FOUND"
                    )
        if i > 0 and "Bullish Engulfing" in patterns:
            ...
            if ok:
                ...
                if logger:
                    logger.info(
                        f"{ticker} {row['pvm'].date().isoformat()} Bullish Engulfing checked - FOUND"
                    )
        if i > 0 and "Piercing Pattern" in patterns:
            ...
            if ok:
                ...
                if logger:
                    logger.info(
                        f"{ticker} {row['pvm'].date().isoformat()} Piercing Pattern checked - FOUND"
                    )
        if i >= 2 and "Three White Soldiers" in patterns:
            ...
            if ok:
                ...
                if logger:
                    logger.info(
                        f"{ticker} {row['pvm'].date().isoformat()} Three White Soldiers checked - FOUND"
                    )
        if i >= 2 and "Morning Star" in patterns:
            ...
            if ok:
                ...
                if logger:
                    logger.info(
                        f"{ticker} {row['pvm'].date().isoformat()} Morning Star checked - FOUND"
                    )
        if "Dragonfly Doji" in patterns:
            ...
            if ok:
                ...
                if logger:
                    logger.info(
                        f"{ticker} {row['pvm'].date().isoformat()} Dragonfly Doji checked - FOUND"
                    )
        if found:
