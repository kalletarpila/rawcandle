...
def _technical_relevance_context_headers() -> list[str]:
    return [
        "ticker",
        "timeframe",
        "signal_date",
...
def _build_technical_relevance_csv_section(
    ...
    lines = [
        ...
        (
            ...
            "dow_trend_state;dow_context_state;latest_bos_direction;"
            "bars_since_latest_bos;bars_since_latest_reset;near_latest_pivot;"
            "near_active_bos_level;is_trend_aligned;is_counter_trend"
        ),
    ]
    for row in rows:
        values = [
            "technical_relevance_context",
            *(_format_value(row.get(header)) for header in _technical_relevance_context_headers()),
        ]
        ...
        output_rows.append(
            {
                ...
                "latest_structure_age_trading_days": layer_synthetic_row.get("latest_structure_age_trading_days"),
                ...
                "latest_bos_age_trading_days": layer_synthetic_row.get("latest_bos_age_trading_days"),
                ...
                "latest_reset_age_trading_days": layer_synthetic_row.get("latest_reset_age_trading_days"),
            ...
            output_rows.append(
                {
                    ...
                    "latest_structure_age_trading_days": subindustry_synthetic_row.get("latest_structure_age_trading_days"),
                    ...
                    "latest_bos_age_trading_days": subindustry_synthetic_row.get("latest_bos_age_trading_days"),
                    ...
                    "latest_reset_age_trading_days": subindustry_synthetic_row.get("latest_reset_age_trading_days"),
                ...
                output_rows.append(
                    {
                        ...
                        "latest_structure_age_trading_days": ticker_output_row.get("latest_structure_age_trading_days"),
                        ...
                        "latest_bos_age_trading_days": ticker_output_row.get("latest_bos_age_trading_days"),
                        ...
                        "latest_reset_age_trading_days": ticker_output_row.get("latest_reset_age_trading_days"),
        ...
        if technical_relevance_run_id is not None:
            ...
            technical_relevance_context_rows = [
                ...
                for row in load_technical_relevance_context(
                    ...
                    timeframe="1d",
                    start_date=normalized_signal_date,
                    end_date=normalized_signal_date,
                )
            ]
    result = {
        "signal_date": normalized_signal_date,
...
def build_markdown_daily_swing_report(
    ...
    *,
    ...
    lines.extend(["", "## 17. Swing Signal Freshness"])
    lines.append(
        _format_table(
            [
                "ticker",
    ...
    lines.extend(["", "## 19. Missing / Incomplete Inputs Summary"])
    missing_rows = [
        {
    ...
    if technical_relevance_run_id is not None:
        lines.extend(["", "## 20. Technical Relevance Context"])
