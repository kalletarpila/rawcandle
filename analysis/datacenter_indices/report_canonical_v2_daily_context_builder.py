    ...
    *,
    ...
    for ticker_row in ticker_rows:
        ...
        output_row = {
            ...
            "ema10": _ticker_source_value(ticker_row, ticker_source_columns, "ema10"),
            "ema20": _ticker_source_value(ticker_row, ticker_source_columns, "ema20"),
            "volume_vs_avg20": _ticker_source_value(ticker_row, ticker_source_columns, "volume_vs_avg20"),
            ...
            "latest_structure_age_trading_days": _ticker_source_value(
                ticker_row, ticker_source_columns, "latest_structure_age_trading_days"
            ),
            ...
            "latest_bos_age_trading_days": _ticker_source_value(
                ticker_row, ticker_source_columns, "latest_bos_age_trading_days"
            ),
            ...
            "latest_reset_age_trading_days": _ticker_source_value(
                ticker_row, ticker_source_columns, "latest_reset_age_trading_days"
            ),
            "latest_reset_freshness": _ticker_source_value(ticker_row, ticker_source_columns, "latest_reset_freshness"),
            "latest_bullish_relevance_reason": _ticker_source_value(
                ticker_row, ticker_source_columns, "latest_bullish_relevance_reason"
            ),
            "latest_bearish_relevance_reason": _ticker_source_value(
                ticker_row, ticker_source_columns, "latest_bearish_relevance_reason"
            ),
