...
def _load_window_context_rows(
    ...
    *,
    ...
    params: list[object] = [signal_date, taxonomy_version, "rolling5"]
    ...
    if market is None:
        conn.execute(
            ...
            WHERE signal_date = ?
              ...
              AND horizon = 'rolling5'
              AND classification_type = 'rolling5_pullback'
            """,
...
def write_report_rolling5_pullback_classification_v2(
    conn: sqlite3.Connection,
    *,
    signal_date: str,
    taxonomy_version: str,
    ...
    classification_version: str = "REPORT_ROLLING5_PULLBACK_CLASSIFIER_V2_1",
    ...
    for row in window_rows:
        result = classify_rolling_5_pullback_row(_classifier_row(row))
        output_rows.append(
            {
                "signal_date": signal_date,
                "taxonomy_version": taxonomy_version,
                ...
                "classification_state": result.rolling_5_pullback_state,
