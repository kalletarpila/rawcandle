            ...
            rows_to_write.append(
                {
                    ...
                    "return_10d": snapshot_row.get("return_10d") if snapshot_row else None,
                    "return_20d": snapshot_row.get("return_20d") if snapshot_row else None,
                    "return_60d": snapshot_row.get("return_60d") if snapshot_row else None,
                    "return_30d": snapshot_row.get("return_30d") if snapshot_row else None,
                    "pct_above_ema20": snapshot_row.get("pct_above_ema20") if snapshot_row else None,
                    "pct_above_ma10": snapshot_row.get("pct_above_ma10") if snapshot_row else None,
                    "ema20_breadth_delta_5d": snapshot_row.get("ema20_breadth_delta_5d") if snapshot_row else None,
                    "ma10_breadth_delta_5d": snapshot_row.get("ma10_breadth_delta_5d") if snapshot_row else None,
                    "trend_breadth": snapshot_row.get("trend_breadth") if snapshot_row else None,
                    "weakness_breadth": snapshot_row.get("weakness_breadth") if snapshot_row else None,
                    "strength_breadth": snapshot_row.get("strength_breadth") if snapshot_row else None,
                    "timing_reason": snapshot_row.get("timing_reason") if snapshot_row else None,
                    "data_quality_status": snapshot_row.get("data_quality_status") if snapshot_row else None,
                    "breadth_json": _build_breadth_json(snapshot_row or {}),
                    "synthetic_close": synthetic_row.get("synthetic_close"),
                    "synthetic_ema20": synthetic_row.get("ema20"),
                    "synthetic_volatility_20d": synthetic_row.get("volatility_20d"),
                    ...
                    "synthetic_latest_structure_age_trading_days": synthetic_row.get("latest_structure_age_trading_days"),
                    "synthetic_latest_bos_event_type": synthetic_row.get("latest_bos_event_type"),
                    "synthetic_latest_bos_event_date": synthetic_row.get("latest_bos_event_date"),
                    "synthetic_latest_bos_age_trading_days": synthetic_row.get("latest_bos_age_trading_days"),
                    ...
                    "synthetic_latest_reset_event_date": synthetic_row.get("latest_reset_event_date"),
                    "synthetic_latest_reset_age_trading_days": synthetic_row.get("latest_reset_age_trading_days"),
                    "synthetic_latest_reset_freshness": synthetic_row.get("latest_reset_freshness"),
                    "synthetic_relative_close_extension_20": synthetic_row.get("relative_close_extension_20"),
                    "synthetic_relative_upper_wick_20": synthetic_row.get("relative_upper_wick_20"),
                    "synthetic_relative_lower_wick_20": synthetic_row.get("relative_lower_wick_20"),
