    ...
    def _create_filters(self) -> ft.Column:
        ...
        self.pattern_filter = ft.Dropdown(
            ...
            options=[
                ...
                ft.dropdown.Option("Bullish Abandoned Baby", "Bullish Abandoned Baby"),
                ft.dropdown.Option("Bullish Flag", "Bullish Flag"),
                ft.dropdown.Option("Bull Rectangle", "Bull Rectangle"),
                ft.dropdown.Option("Ascending Triangle", "Ascending Triangle"),
                ft.dropdown.Option("Bullish Pennant", "Bullish Pennant"),
                ft.dropdown.Option("Cup and Handle", "Cup and Handle"),
                ...
                ft.dropdown.Option("Falling Three Methods", "Falling Three Methods"),
                ft.dropdown.Option("Bearish Flag", "Bearish Flag"),
                ft.dropdown.Option("Bear Rectangle", "Bear Rectangle"),
                ft.dropdown.Option("Descending Triangle", "Descending Triangle"),
                ft.dropdown.Option("Bearish Pennant", "Bearish Pennant"),
