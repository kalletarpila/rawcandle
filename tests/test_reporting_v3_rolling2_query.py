...
def test_query_returns_rolling2_structured_data_from_eco_facts(tmp_path) -> None:
    ...
    assert data.watchlist_summary["counts"]["breakout_count"] == 0
    ...
    assert data.watchlist_summary["rows"][0]["breakout_days"] == 0.0
    assert data.watchlist_summary["rows"][0]["pullback_days"] == 1.0
    assert data.watchlist_summary["rows"][0]["exit_risk_days"] == 2.0
